...
## Anti-AI prose (mandatory)

The shared file `anti-ai-prose.md` is loaded via `always_load`. Its banned-pattern list and principles are **non-negotiable**. After drafting every section, scan the output for:

- Chinese: 标志性、反直觉、揭示了、值得注意的是、不言而喻、革命性、开创性、深远、为...开辟、核心瓶颈、有力证明、系统性地、核心贡献在于、这一鸿沟的根源
- English: It is worth noting that, notably, sheds light on, paves the way for, groundbreaking, pioneering, a growing body of evidence

If any banned pattern is found, rewrite the sentence. No exceptions. This is the single most visible quality signal separating human-written from AI-generated academic prose.
